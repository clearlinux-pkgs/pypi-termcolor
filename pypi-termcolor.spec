...
Source0  : https://files.pythonhosted.org/packages/19/da/ff1f0906818a5bd2e69e773d88801ca3c9e92d0d7caa99db1665658819ea/termcolor-2.1.1.tar.gz
...
%prep
%setup -q -n termcolor-2.1.1
cd %{_builddir}/termcolor-2.1.1
pushd ..
cp -a termcolor-2.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669055675
