...
Source0  : https://files.pythonhosted.org/packages/62/1a/e78a930f70dd576f2a7250a98263ac973a80d6f1a395d89328844881a0c0/termcolor-2.1.0.tar.gz
...
%prep
%setup -q -n termcolor-2.1.0
cd %{_builddir}/termcolor-2.1.0
pushd ..
cp -a termcolor-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667228276
