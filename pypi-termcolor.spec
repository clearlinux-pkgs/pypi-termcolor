...
Source0  : https://files.pythonhosted.org/packages/e5/4e/b2a54a21092ad2d5d70b0140e4080811bee06a39cc8481651579fe865c89/termcolor-2.2.0.tar.gz
...
%prep
%setup -q -n termcolor-2.2.0
cd %{_builddir}/termcolor-2.2.0
pushd ..
cp -a termcolor-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672786219
