...
Source0  : https://files.pythonhosted.org/packages/ca/6c/3d75c196ac07ac8749600b60b03f4f6094d54e132c4d94ebac6ee0e0add0/termcolor-3.1.0.tar.gz
...
%prep
%setup -q -n termcolor-3.1.0
cd %{_builddir}/termcolor-3.1.0
pushd ..
cp -a termcolor-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746025594
