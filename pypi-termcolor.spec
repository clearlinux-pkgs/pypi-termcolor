...
Version  : 2.0.0
Release  : 5
URL      : https://files.pythonhosted.org/packages/d7/99/8fd6784741a4f533aa1da09c45a3dfbeb7d0454cc653384a6eefd958cf3d/termcolor-2.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/d7/99/8fd6784741a4f533aa1da09c45a3dfbeb7d0454cc653384a6eefd958cf3d/termcolor-2.0.0.tar.gz
...
%prep
%setup -q -n termcolor-2.0.0
cd %{_builddir}/termcolor-2.0.0
pushd ..
cp -a termcolor-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662922005
